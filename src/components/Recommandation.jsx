...
export default function Recommandation({ recommendation }) {
  ...
  return (
    <section
      className={`flex items-start gap-[18px] w-full rounded-2xl border-l-[5px] border-solid shadow-md p-7 max-[480px]:p-5 transition-transform duration-200 hover:-translate-y-1 animate-rise [animation-delay:160ms] ${style.card}`}
