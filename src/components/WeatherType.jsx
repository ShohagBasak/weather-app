...
export default function WeatherType({ weather, place }) {
  ...
  return (
    <section
      className="relative overflow-hidden w-full rounded-2xl shadow-2xl ring-1 ring-inset ring-white/40 px-7 py-8 max-[480px]:px-5 max-[480px]:py-6 animate-rise [animation-delay:80ms]"
    ...
    >
      ...
      <div className="relative flex flex-col items-center text-center">
        <span className="rounded-2xl px-2 py-1 self-start" style={{ background: theme.chip, color: theme.ink }}>
